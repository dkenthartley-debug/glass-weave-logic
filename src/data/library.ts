...
export const librarySeries: LibrarySeries[] = [
  ...
  },
  {
    ...
    scope: "S Series",
    purpose:
      "Concise product and design specifications for HLG conductive interlayers, heater mats, sensor mats, and shielding subassemblies.",
    docs: [
      {
        id: "S.02",
        ...
        revision: "Revision A",
        summary:
          "Fine copper mesh to printed copper interlayers ready to laminate.",
      ...
      },
      {
        ...
        revision: "Revision A",
        summary:
          "Current heated interlayer voltage range: 12 V to 440 V DC.",
      ...
      },
      {
        ...
        revision: "Revision A",
        summary:
          "Sensor mats are engineered with custom layouts for accurate placement and lower-stress laminates.",
      ...
      },
      {
        ...
        revision: "Revision A",
        summary:
          "Each design is thermally tested in-house for thermal uniformity.",
