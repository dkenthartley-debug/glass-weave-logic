...
import { ArrowRight, BookOpen, FileDown, FileText, Notebook, FileStack, Award } from "lucide-react";
...
const kinds = [
  ...
  { kind: "Qualification Standard", icon: Award, blurb: "Proprietary Hotlineglass qualification frameworks for advanced transparent systems." },
